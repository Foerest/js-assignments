...
function getRegexForSSN() {
   //throw new Error('Not implemented');
    return /([1-9]\d+|\d[1-9]\d+|\d\d[1-9])-([1-9]\d|\d[1-9])-([1-9]\d+|\d[1-9]\d+|\d\d\d[1-9]|\d\d[1-9]\d)$/;
    ///([1-9][0-9][0-9]|[0-9][1-9][0-9]|[0-9][0-9][1-9])-([1-9][0-9]|[0-9][1-9])-([1-9][0-9][0-9][0-9]|[0-9][1-9][0-9][0-9]|[0-9][0-9][1-9][0-9]|[0-9][0-9][0-9][1-9])/
}
